...
export declare class experimental_AstroContainer {
     ...
     *
     * ```js
     * import ProjectTile from "../src/components/ProjectTile.astro";
     *
     * const container = await AstroContainer.create();
     * const result = await container.renderToString(ProjectTile);
     *
     ...
     *
     * const container = await AstroContainer.create();
     * const response = await container.renderToResponse(ProjectTile);
     *
